...
Usage:
    python link_account.py --manager 1234567890 --client 2345678901
    python link_account.py --check --manager 1234567890 --client 2345678901
    python link_account.py --manager 1234567890 --client 2345678901 --set-login
"""
